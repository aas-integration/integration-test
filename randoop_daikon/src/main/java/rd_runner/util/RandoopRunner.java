...
public class RandoopRunner extends AbstractRunner{
	 ...
	 * @param classPath class path needed to run the application
	 * @param classListFile list of names of all classes for which test cases should be generated
	 * @param testDir directory where the generated test cases are written to
	 * @param timeSec max time for running randoop
	 * @param outputLimit max number of generated test cases.
	 */
